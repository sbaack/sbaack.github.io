...
@task
def update(c):
    """Update or install project dependencies, including pip and invoke itself."""
    c.run("python -m pip install --upgrade pip invoke")
    c.run("python -m pip install -Ur requirements.in")
